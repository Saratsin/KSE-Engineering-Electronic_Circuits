...
\fancyhead[L]{KSE University – Engineering School}
...
& \;\;\, I_D = \begin{cases}
  ...
  2 \cdot n \cdot V_T \leq V_{ov} \ll E_C \cdot L
  , \\[0.5em]
  %k^{\prime} \cdot \frac{W}{L} \cdot (V_{GS} - V_{th}) \cdot V_{DS}, & \, 
  %V_{DS} \ll V_{ov}
  %, \quad 
  %2 \cdot n \cdot V_T \leq V_{ov} \ll E_C \cdot L
  %, \\[0.5em]
  ...
  %V_A \not \rightarrow \infty
  %, \\[0.5em]
  %\frac{k^{\prime}}{2} \cdot \frac{W}{L} \cdot (V_{GS} - V_{th})^2, & \; 
  %V_{DS} \geq V_{ov}
  %, \quad 
  %2 \cdot n \cdot V_T \leq V_{ov} \ll E_C \cdot L
  %, \;\; 
  ...
  V_{ov} \cong E_C \cdot L
  , \\[0.5em]
  %k^{\prime} \cdot \frac{1}{1 + \frac{V_{DS}}{E_c \cdot L}} \cdot \frac{W}{L} \cdot (V_{GS} - V_{th}) \cdot V_{DS}, & \; 
  %V_{DS} \ll V_{ov}
  %, \;\;\; 
  %V_{ov} \cong E_C \cdot L
  %, \\[0.5em]
